...
<head>
    ...
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js">
        ...
        <script src="https://cdpn.io/cpe/boomboom/pen.js?key=pen.js-69526345-5587-033e-6aa6-e92067cc79aa" crossorigin=""></script>
</head>
...
.signup-wrapper .signup-form .form input[type=text],.signup-wrapper .signup-form .form input[type=password],.signup-wrapper .signup-form .form input[type=email]{
    border: none;
...
<div class="content-wrapper">
    ...
    if (isset($_GET['message']) && $_GET['message'] == "success") {
        echo '<div class="alert alert-success" role="alert" style="background-color: #d4edda; color: #155724; border-color: #c3e6cb; border-radius: .25rem; padding: 1rem;">Registration successful!</div>';
    }
                    ...
                    <div class="wrapper-2">
                        ...
                        <div class="form">
                            <form action="create.php" method="POST">
                                ...
                                <button type="submit" style= "color: white" class="btn">REGISTER</button>
                            </form><br>
                            <button class="btn"><div class="alert alert-success" role="alert" > <a href="login.php" style="color: red;">Click login</a></div></button>
